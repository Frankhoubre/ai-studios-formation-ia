...
export const sdxlEtalonnerPeauLumiere: Article = {
  ...
  category: "ia-image",
  tags: ["SDXL", "etalonnage", "peau realistic"],
  date: "2026-04-27",
  ...
  keywords: [
    "SDXL",
    "etalonner des portraits SDXL pour un rendu cinema naturel",
  ...
  content: [
    ...
    {
      type: "p",
      text: "Le premier levier n'est pas le prompt poetique, c'est l'intention visuelle. Si tu ne sais pas ce que la scène doit faire ressentir, l'IA improvise et te sort une moyenne generique. Pour etalonner des portraits SDXL pour un rendu cinema naturel, commence toujours par une phrase humaine: qui regarde, quoi ressent, quelle action doit suivre. C'est basique, mais c'est la base de tout le reste.",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "Ouvre ton outil principal pour etalonner des portraits SDXL pour un rendu cinema naturel, cree un dossier projet unique avec trois sous dossiers, références, sorties brutes, sorties valides. Ce detail parait administratif, pourtant il te sauve quand tu dois revenir sur une version precise. Ensuite fixe ton format principal en 16:9, même si tu sors ensuite en 9:16, tu gardes une base narrative stable.",
    },
    {
      type: "p",
