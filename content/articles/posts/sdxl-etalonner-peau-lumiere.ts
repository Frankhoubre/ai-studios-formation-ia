...
export const sdxlEtalonnerPeauLumiere: Article = {
  ...
  description:
    "Masterclass complete pour etalonner des portraits SDXL pour un rendu cinema naturel, avec workflow debutant detaille, erreurs frequentes et correction technique orientee resultats.",
  excerpt:
  ...
  content: [
    {
      type: "p",
      text: "slug: sdxl-etalonner-peau-lumiere
