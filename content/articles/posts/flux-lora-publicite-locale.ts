...
export const fluxLoraPubliciteLocale: Article = {
  ...
  tags: ["Flux LoRA", "publicite locale IA", "image cinematique"],
  date: "2026-04-25",
  ...
  keywords: [
    "Flux LoRA",
    "creer des visuels publicitaires locaux avec Flux et LoRA",
  ...
  content: [
    ...
    {
      type: "p",
      text: "Le premier levier n'est pas le prompt poetique, c'est l'intention visuelle. Si tu ne sais pas ce que la scène doit faire ressentir, l'IA improvise et te sort une moyenne generique. Pour creer des visuels publicitaires locaux avec Flux et LoRA, commence toujours par une phrase humaine: qui regarde, quoi ressent, quelle action doit suivre. C'est basique, mais c'est la base de tout le reste.",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "Ouvre ton outil principal pour creer des visuels publicitaires locaux avec Flux et LoRA, cree un dossier projet unique avec trois sous dossiers, références, sorties brutes, sorties valides. Ce detail parait administratif, pourtant il te sauve quand tu dois revenir sur une version precise. Ensuite fixe ton format principal en 16:9, même si tu sors ensuite en 9:16, tu gardes une base narrative stable.",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "Quand tu passes en video, applique la même logique. Tu controles amplitude et vitesse de mouvement. Un travelling trop propre donne tout de suite un rendu artificiel. Mieux vaut un mouvement plus court, plus motive, avec un point d'accroche narratif. Tu privilegies la credibilite au spectacle gratuit.",
    },
    {
      type: "p",
