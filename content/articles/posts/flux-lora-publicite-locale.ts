...
export const fluxLoraPubliciteLocale: Article = {
  ...
  description:
    "Masterclass complete pour creer des visuels publicitaires locaux avec Flux et LoRA, avec workflow debutant detaille, erreurs frequentes et correction technique orientee resultats.",
  excerpt:
  ...
  content: [
    {
      type: "p",
      text: "slug: flux-lora-publicite-locale
