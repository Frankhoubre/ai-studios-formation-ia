...
export const ideogramTypographieAfficheCinema: Article = {
  ...
  description:
    "Masterclass complete pour creer une affiche cinema lisible avec Ideogram, avec workflow debutant detaille, erreurs frequentes et correction technique orientee resultats.",
  excerpt:
