...
export const ideogramTypographieAfficheCinema: Article = {
  ...
  category: "prompting",
  tags: ["Ideogram", "affiche cinema", "typographie IA"],
  date: "2026-04-28",
  ...
  keywords: [
    "Ideogram",
    "creer une affiche cinema lisible avec Ideogram",
  ...
  content: [
    ...
    {
      type: "p",
      text: "Le premier levier n'est pas le prompt poetique, c'est l'intention visuelle. Si tu ne sais pas ce que la scène doit faire ressentir, l'IA improvise et te sort une moyenne generique. Pour creer une affiche cinema lisible avec Ideogram, commence toujours par une phrase humaine: qui regarde, quoi ressent, quelle action doit suivre. C'est basique, mais c'est la base de tout le reste.",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "Ouvre ton outil principal pour creer une affiche cinema lisible avec Ideogram, cree un dossier projet unique avec trois sous dossiers, références, sorties brutes, sorties valides. Ce detail parait administratif, pourtant il te sauve quand tu dois revenir sur une version precise. Ensuite fixe ton format principal en 16:9, même si tu sors ensuite en 9:16, tu gardes une base narrative stable.",
    },
    {
      type: "p",
