...
export const stabilitePersonnageMultiPlans: Article = {
  title: "Stabilite personnage multi-plans: eviter les derives de visage",
  slug: "stabilite-personnage-multi-plans",
  description:
    "Masterclass complete pour maintenir un personnage coherent sur plusieurs plans IA, avec workflow debutant detaille, erreurs frequentes et correction technique orientee resultats.",
  excerpt:
  ...
  imageAlt:
    "Stabilite personnage multi-plans: eviter les derives de visage avec workflow cinema realiste et rendu naturel",
  keywords: [
    "personnage coherent",
