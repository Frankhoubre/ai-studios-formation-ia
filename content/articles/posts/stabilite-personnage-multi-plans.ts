...
export const stabilitePersonnageMultiPlans: Article = {
  ...
  category: "ia-image",
  tags: ["personnage cohérent", "consistance IA", "multi plans"],
  date: "2026-05-02",
  ...
  keywords: [
    "personnage cohérent",
    "maintenir un personnage cohérent sur plusieurs plans IA",
  ...
  content: [
    ...
    {
      type: "p",
      text: "Le premier levier n'est pas le prompt poetique, c'est l'intention visuelle. Si tu ne sais pas ce que la scène doit faire ressentir, l'IA improvise et te sort une moyenne generique. Pour maintenir un personnage cohérent sur plusieurs plans IA, commence toujours par une phrase humaine: qui regarde, quoi ressent, quelle action doit suivre. C'est basique, mais c'est la base de tout le reste.",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "Ouvre ton outil principal pour maintenir un personnage cohérent sur plusieurs plans IA, cree un dossier projet unique avec trois sous dossiers, références, sorties brutes, sorties valides. Ce detail parait administratif, pourtant il te sauve quand tu dois revenir sur une version precise. Ensuite fixe ton format principal en 16:9, même si tu sors ensuite en 9:16, tu gardes une base narrative stable.",
    },
    {
      type: "p",
