...
export const sunoMusiquePubCourte: Article = {
  ...
  content: [
    ...
    {
      type: "p",
      text: "Dans Suno, cree un nouveau projet et fixe d'entree la durée cible de la pub, 10, 15 ou 20 secondes selon ton format. Si tu peux generer plus long, fais le, mais prevois ton point de coupe ideal. Le but n'est pas d'avoir un morceau complet, c'est d'avoir une section exploitable qui soutient le message.",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "Pour rester coherent avec ton univers visuel, associe une phrase de direction image a ton prompt audio. Si ta pub vise un rendu cinema local realiste, appuie toi sur [notre guide complet sur les modeles Flux](/blog/prompt-image-ia-cinema) pour que son et image parlent la même langue emotionnelle.",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "Pour appuyer ta méthode avec une ressource de reference, regarde [documentation officielle DaVinci Resolve](https://www.blackmagicdesign.com/products/davinciresolve). Même si c'est une suite video, la logique de timeline, de rythme et de relation image son est excellente pour comprendre les points de synchronisation.",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "Une bonne musique mal synchronisee ressemble a une erreur de montage. Tu dois placer des points d'appui clairs sur les transitions visuelles, reveal produit, apparition prix, fin de phrase voix off. Sans ça, ton spot semble amateur même avec un bon son.",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "N'oublie pas la plateforme. Un format social avec lecture auto n'a pas le même comportement qu'une video regardee volontairement avec son. Adapte ton attaque musicale selon le contexte.",
    },
    {
      type: "p",
