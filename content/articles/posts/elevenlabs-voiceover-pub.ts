...
export const elevenlabsVoiceoverPub: Article = {
  ...
  category: "ia-video",
  tags: ["ElevenLabs", "voice over", "mix audio"],
  date: "2026-04-30",
  ...
  keywords: [
    "ElevenLabs",
    "produire une voix off publicitaire avec ElevenLabs",
  ...
  content: [
    ...
    {
      type: "p",
      text: "Le premier levier n'est pas le prompt poetique, c'est l'intention visuelle. Si tu ne sais pas ce que la scène doit faire ressentir, l'IA improvise et te sort une moyenne generique. Pour produire une voix off publicitaire avec ElevenLabs, commence toujours par une phrase humaine: qui regarde, quoi ressent, quelle action doit suivre. C'est basique, mais c'est la base de tout le reste.",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "Ouvre ton outil principal pour produire une voix off publicitaire avec ElevenLabs, cree un dossier projet unique avec trois sous dossiers, références, sorties brutes, sorties valides. Ce detail parait administratif, pourtant il te sauve quand tu dois revenir sur une version precise. Ensuite fixe ton format principal en 16:9, même si tu sors ensuite en 9:16, tu gardes une base narrative stable.",
    },
    {
      type: "p",
