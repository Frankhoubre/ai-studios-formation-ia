...
export const elevenlabsVoiceoverPub: Article = {
  ...
  description:
    "Masterclass complete pour produire une voix off publicitaire avec ElevenLabs, avec workflow debutant detaille, erreurs frequentes et correction technique orientee resultats.",
  excerpt:
  ...
  content: [
    {
      type: "p",
      text: "slug: elevenlabs-voiceover-pub
