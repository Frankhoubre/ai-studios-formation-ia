...
export const storyboardShotlistNotionIa: Article = {
  title: "Storyboard + shot list: methode Notion pour tourner vite avec l IA",
  slug: "storyboard-shotlist-notion-ia",
  description:
    "Masterclass complete pour organiser storyboard et shot list dans Notion pour une prod IA, avec workflow debutant detaille, erreurs frequentes et correction technique orientee resultats.",
  excerpt:
  ...
  imageAlt:
    "Storyboard + shot list: methode Notion pour tourner vite avec l IA avec workflow cinema realiste et rendu naturel",
  keywords: [
    "storyboard IA",
