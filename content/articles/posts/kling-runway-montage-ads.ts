...
export const klingRunwayMontageAds: Article = {
  ...
  content: [
    ...
    {
      type: "p",
      text: "Ouvre ton outil principal pour produire un spot publicitaire court avec Kling et Runway, cree un dossier projet unique avec trois sous dossiers, references, sorties brutes, sorties valides. Ce detail parait administratif, pourtant il te sauve quand tu dois revenir sur une version precise. Ensuite fixe ton format principal en 16:9, même si tu sors ensuite en 9:16, tu gardes une base narrative stable.",
    },
    {
      type: "p",
