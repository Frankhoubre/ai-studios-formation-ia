...
export const klingRunwayMontageAds: Article = {
  ...
  description:
    "Masterclass complete pour produire un spot publicitaire court avec Kling et Runway, avec workflow debutant detaille, erreurs frequentes et correction technique orientee resultats.",
  excerpt:
