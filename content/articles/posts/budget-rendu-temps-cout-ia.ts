...
export const budgetRenduTempsCoutIa: Article = {
  ...
  description:
    "Masterclass complete pour chiffrer une production IA avec budget, temps et rendu, avec workflow debutant detaille, erreurs frequentes et correction technique orientee resultats.",
  excerpt:
  ...
  content: [
    {
      type: "p",
      text: "slug: budget-rendu-temps-cout-ia
